...
private val DarkColorScheme = darkColorScheme(
    ...
    onPrimary = DarkOnBackground, onSecondary = DarkOnBackground,
    onBackground = DarkOnBackground, onSurface = DarkOnSurface,
    error = Error, onError = DarkOnBackground,
)
...
private val LightColorScheme = lightColorScheme(
    ...
    onPrimary = LightOnBackground, onSecondary = LightOnBackground,
    onBackground = LightOnBackground, onSurface = LightOnSurface,
    error = Error, onError = LightOnBackground,
)
